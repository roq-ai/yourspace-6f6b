  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to yourspace - Navigating shared spaces with ease. Find or offer free spaces in real time, color-coded for your convenience. Your space, your time, your choice."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzaGFyaW5nJTIwc3BhY2UlMkNnb29nbGUlMjBtYXB8ZW58MHx8fHwxNjg5NzgwODg1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to yourspace - Navigating shared spaces with ease. Find or offer free spaces in real time, color-coded for your convenience. Your space, your time, your choice.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Space Owner" type="space-owner" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
